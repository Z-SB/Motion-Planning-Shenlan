    ...
    */
    ...
    while ( !openSet.empty() ){
       ...
       //set currentPtr to the node with lowest cost in openList
        ...
        // int count = 0; // check if the traverse in openList works
        ...
        // ROS_WARN("get %i neighbors",(int)neighborPtrSets.size() );
        /*
        *
        *
        ...
        */         
        for(int i = 0; i < (int)neighborPtrSets.size(); i++){
            ...
            */
            ...
            //    ROS_WARN("Add a node in open list");
                ...
                *        
                */
               // if need update, set gScore, fScore, parentNode, and put it in openSet
                neighborPtr->gScore = tentative_gScore;
                neighborPtr->fScore =  tentative_gScore+getHeu(neighborPtr,endPtr);   
                neighborPtr-> cameFrom = currentPtr;
                openSet.insert( make_pair(neighborPtr->fScore, neighborPtr) );
            ...
            //    ROS_WARN("Update  a node in open list");
            }      
        }
    }
    //if search fails
